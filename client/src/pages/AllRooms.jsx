...
const AllRooms = () => {
    ...
    // Filter and sort rooms based on the selectes filters and sort option
        ...
        justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32" >
            <div>
                <div className="flex flex-col items-start text-left">
                    ...
                    <p className="text-sm md:twxt-base text-gray-500/90 mt-2
                ...
                {filteredRooms.map((room) => (
                    ...
                    border-b border-gray-300 last:pb-30 last:border-0">
                        ...
                        <div className="md:w-1/2 flex flex-col gap-2">
                            ...
                            text-sm">
                                <img src={assets.locationIcon} alt="locations-icon" />
